...
namespace Services.CoreService
{
    ...
    public class SpawnComponent : MonoBehaviour, ICoreComponent, IPointerDownHandler, IPointerUpHandler
    {
        [SerializeField] 
        ...
        private void EndDragItem()
        {
            ...
            BarrierEvents<ItemEndDrag>.Publish();
        }
        ...
        private async UniTask Spawn(string excludeItemId = "")
        {
            ...
            BarrierEvents<ItemSpawnedEvent>.Publish();
        }
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            _isDrag = true;
            DragItem();
            BarrierEvents<ItemBeginDrag>.Publish();
        }
